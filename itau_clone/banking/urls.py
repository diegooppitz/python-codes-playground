...
from .views import AccountCreate, AccountDetail, AccountDelete, AccountsList, BalanceDetailView, PixTransferAPIView, CreditCardList, CreditCardStatementView, CreditCardCreate, CreditCardDelete
...
urlpatterns = [
    ...
    path('credit-cards/', CreditCardList.as_view(), name='credit-card-list'),
    ...
    path('credit-cards/<str:card_number>/', CreditCardStatementView.as_view(), name='credit-card-statements'),
]